...
class ListArt extends StatefulWidget {
  ...
  ListArt({Key? key, required this.user_id}) : super(key: key);
...
class _ListArtState extends State<ListArt> {
  ...
  Future getdata() async {
    var url = Uri.parse("http://10.0.2.2//historyproject/joinArt.php");
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                          'images/imgart/${list[index]['img_person']}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
