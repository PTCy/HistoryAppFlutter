...
class ListDomination extends StatefulWidget {
  final String user_id;
  ListDomination({Key? key, required this.user_id}) : super(key: key);

  @override
  State<ListDomination> createState() => _ListDominationState();
}

class _ListDominationState extends State<ListDomination> {
  Future getdata() async {
    var url = Uri.parse("http://10.0.2.2//historyproject/joinDomination.php");
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                          'images/imgdomination/${list[index]['img_person']}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
