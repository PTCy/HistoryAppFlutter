...
class ListScience extends StatefulWidget {
  final String user_id;
  ListScience({Key? key, required this.user_id}) : super(key: key);

  @override
  State<ListScience> createState() => _ListScienceState();
}

class _ListScienceState extends State<ListScience> {
  Future getdata() async {
    var url = Uri.parse("http://10.0.2.2//historyproject/joinSciene.php");
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                          'images/imgscience/${list[index]['img_person']}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
