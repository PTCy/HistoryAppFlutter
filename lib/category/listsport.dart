...
class ListSport extends StatefulWidget {
  ...
  ListSport({Key? key, required this.user_id}) : super(key: key);
...
class _ListSportState extends State<ListSport> {
  Future getdata() async {
    var url = Uri.parse("http://10.0.2.2//historyproject/joinSport.php");
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                          'images/imgsport/${list[index]['img_person']}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
